                    ...
                    <div className="row g-4">
                        <div className="col-lg-8">
                            <div className="how-work-content">
                                <p className="text wow fadeInUp">
                                    Implementasi Disiplinku sangat mudah dan cepat untuk perusahaan Anda. Ikuti langkah sederhana berikut untuk mulai mengelola karyawan dengan lebih efisien.
                                </p>
                                <div className="row g-4">
                                    {data.map((item, index) => (
                        ...
                        <div className="col-lg-4 wow fadeInUp" data-wow-delay=".3s">
                            <div className="gap-image">
                                <Image src="/assets/images/disiplinku/mobile_app_demo.png" alt="img" width={376} height={431} />
                            </div>
                        </div>
                    </div>
                </div>
