                            ...
                            <div className="wcu-content">
                                <div className="section-title">
                                    <div className="subtitle wow fadeInUp" data-wow-delay=".2s">
                                        Kustomisasi & Analisa <Image src="/assets/images/icon/fireIcon.svg" alt="img" width={16} height={17}   />
                                    </div>
                                    <h2 className="title wow fadeInUp" data-wow-delay=".4s">Kelola Data & Analisis Kinerja
                                        Dengan Mudah</h2>
                                    <p className="text1 wow fadeInUp" data-wow-delay=".6s">Dapatkan insight mendalam tentang kinerja tim Anda dengan dashboard analitik yang powerful. Pantau kehadiran, produktivitas, dan tren dalam satu tempat.</p>
                                    <p className="text2 wow fadeInUp" data-wow-delay=".8s">Ekspor laporan secara otomatis untuk kebutuhan administrasi dan pengambilan keputusan strategis perusahaan Anda.</p>
                                </div>
                                <Link className="theme-btn rounded-5 wow fadeInUp" data-wow-delay=".4s" href="/about">Lihat
                                    Semua Proyek
                        ...
                        <div className="col-xl-6">
                            <div className="wcu-thumb">
                                ...
                                <div className="thumb-box float-bob-y wow fadeInUp" data-wow-delay=".4s">
                                    ...
                                    <p className="text">Total pertumbuhan pengguna 45%</p>
