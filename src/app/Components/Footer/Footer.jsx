                        ...
                        <div className="col-xl-4 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".2s">
                            <div className="single-footer-widget">
                                ...
                                <div className="footer-content">
                                    <p>
                                        Disiplinku adalah solusi manajemen presensi dan HR digital terdepan untuk membantu perusahaan mengelola SDM dengan lebih efisien dan akurat.
                                    </p>
                                    <div className="store-links">
                                        <div className="apple">
                                            <a href="#" target="_blank" rel="noopener noreferrer"><svg xmlns="http://www.w3.org/2000/svg" width="19" height="17"
                                        ...
                                        <div className="play">
                                            <a href="#" target="_blank" rel="noopener noreferrer"><svg xmlns="http://www.w3.org/2000/svg" width="26" height="17"
                        ...
                        <div className="col-xl-8 col-lg-8 col-md-12">
                            <div className="single-footer-widget">
                                <div className="contact-box">
                                    <div className="subtitle">Alamat</div>
                                    <div className="widget-head">Siap Memulai?</div>
                                    <div className="text">Hubungi kami untuk informasi lebih lanjut tentang solusi Disiplinku.
                                    </div>
                                    <div className="info">
                                        <div className="icon">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="23"
                                                ...
                                                <path
                                                    d="M11 11.9167C12.5188 11.9167 13.75 10.6855 13.75 9.16667C13.75 7.64782 12.5188 6.41667 11 6.41667C9.48116 6.41667 8.25 7.64782 8.25 9.16667C8.25 10.6855 9.48116 11.9167 11 11.9167Z"
                                                    stroke="#5236FF" strokeWidth="2" strokeLinecap="round"
                                                    strokeLinejoin="round" />
                                                <path
                                                    d="M11 1.83366C8.09751 1.83366 5.31293 3.18714 3.43755 5.46252C1.56217 7.7379 0.75 10.7237 0.75 13.6253C0.75 16.5269 1.56217 19.5127 3.43755 21.7881C5.31293 24.0635 8.09751 25.417 11 25.417C13.9025 25.417 16.6871 24.0635 18.5625 21.7881C20.4378 19.5127 21.25 16.5269 21.25 13.6253C21.25 10.7237 20.4378 7.7379 18.5625 5.46252C16.6871 3.18714 13.9025 1.83366 11 1.83366ZM11 21.2087C8.66562 21.2087 6.42812 20.0784 4.86793 18.3033C3.30774 16.5283 2.58337 14.2662 2.58337 11.8753C2.58337 9.48446 3.30774 7.22234 4.86793 5.44732C6.42812 3.67231 8.66562 2.54199 11 2.54199C13.3344 2.54199 15.5719 3.67231 17.1321 5.44732C18.6923 7.22234 19.4166 9.48446 19.4166 11.8753C19.4166 14.2662 18.6923 16.5283 17.1321 18.3033C15.5719 20.0784 13.3344 21.2087 11 21.2087Z"
                                                    stroke="#5236FF" strokeWidth="2" strokeLinecap="round"
                                                    strokeLinejoin="round" />
                                            </svg>
                                        </div>
                                        <div className="link">
                                            JDC Business Center Lt.6 JI. Jendral Gatot Subroto Kav. 53, Slipi - Jakarta Pusat <br/>
                                            Research & Development : Jl. Ciliwung Raya No. 3, Sukahati Kec. Cibinong, Bogor, Jawa Barat 16913
                                        </div>
                                    </div>
                                    <div className="info">
                                        ...
                                        <div className="link">
                                            <a href="mailto:halo@disiplinku.id">halo@disiplinku.id</a>
                                        </div>
                                    </div>
                                    <div className="info">
                                        <div className="icon">
                                        ...
                                        <div className="link">
                                            <a href="tel:+62215304658">(021) 5304658</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div className="container">
                    <div className="footer-wrapper d-flex align-items-center justify-content-between">
                        <p className="wow fadeInLeft" data-wow-delay=".3s">
                            Copyright © PT. Technosoft Indoprima. All rights reserved.
                        </p>
                    </div>
                </div>
            </div>
